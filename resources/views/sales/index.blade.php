                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">List of Sales</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="main col-md-12 float-right">
                    <form method="get" action="{{ route('sale.sales') }}">
                            ...
                            <div class="form-group col-md-3">
                                <div class="input-group-prepend">
                                    <input type="text" name="param" id="param" class="form-control clearable"
                                           value="{{ @$request['param'] }}" placeholder="Search Sale">
                                </div>
                            </div>
            ...
            <div class="btn-group float-right" role="group">
                <a href="{{ route('sale.create') }}"  class="form-control btn btn-primary"  type="button">
                    New Sale
                </a>
            </div>
            <br>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <table class="table table-striped">
                        ...
                        @else
                            <tr>
                                <td colspan="6"><strong>No sale data</strong></td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
            ...
            <div class="float-left">
                <b>Total Records: </b> {{ $sales->total() }}
            </div>
            <div class="float-right">
                <nav>
                    <ul>
                        {!! $sales->setPath('')->appends(\Illuminate\Support\Facades\Request::query())->links() !!}
                    </ul>
                </nav>
            </div>
            <!-- /.card -->
