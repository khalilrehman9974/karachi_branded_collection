...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1>List of Sales Return</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                            <li class="breadcrumb-item active">List of Sales Return</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="main col-md-12 float-right">
                    <form method="get" action="{{ route('sale-return.sales-return') }}">
                            ...
                            <div class="form-group col-md-3">
                                <div class="input-group-prepend">
                                    <input type="text" name="param" id="param" class="form-control clearable"
                                           value="{{ @$request['param'] }}" placeholder="Search Sale Return">
                                </div>
                            </div>
            ...
            <div class="btn-group float-right" role="group">
                <a href="{{ route('sale-return.create') }}"  class="form-control btn btn-primary"  type="button">
                    New Sale Return
                </a>
            </div>
            <br>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <table class="table table-striped">
                                ...
                                <tr class="sale-return{{ $sale->id }}">
                                    ...
                                    <td class="project-actions float-right">
                                        <a class="btn btn-primary btn-sm" target="_blank"
                                           href="{{ route('sale-return.view',$sale->id) }}"
                                           id="view-package1" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a class="btn btn-primary btn-sm"
                                           href="{{ route('sale-return.edit', $sale->id) }}"
                                           data-id="{{ $sale->id }}" title="Edit">
                        ...
                        @else
                            <tr>
                                <td colspan="6"><strong>No sale return data</strong></td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
            ...
            <div class="float-left">
                <b>Total Records: </b> {{ $salesReturns->total() }}
            </div>
            <div class="float-right">
                <nav>
                    <ul>
                        {!! $salesReturns->setPath('')->appends(\Illuminate\Support\Facades\Request::query())->links() !!}
                    </ul>
                </nav>
            </div>
            <!-- /.card -->
    ...
    <script>
        ...
        var config = {
            routes: {
                deleteSale: "{{ url('sale-return/delete') }}",
            },
            totalRecords: {{  $salesReturns->total() }}
        };
